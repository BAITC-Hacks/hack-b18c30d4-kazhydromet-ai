...
METRICS_GLOSSARY = {
    ...
    "in_core": "входит в крупнейшее кольцо возвратных потоков (сильно связная компонента из 85 узлов)",
    ...
    "anomaly_flags": "сработавшие правила аномалий: дробление (≥70% входящих по 5–10 тыс. ₸), повтор одной суммы ≥8 раз, "
