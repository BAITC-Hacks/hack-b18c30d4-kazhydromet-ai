...
Кейс Freedom «Граф денег». Правила ролей, THRESHOLDS и формула приоритета не менялись. Ссылки организаторов скачаны повторно: все 6 файлов совпали с сохранёнными, рабочие Parquet совпали с архивом; русский текст ТЗ тот же.
